...
Scheme
{
	...
	BaseSettings
	{
		...
		Border.Bright						"LightBlue"				// top left border 
		Border.Dark							"LightBlue"				// bottom right border
		...
		RichText.SelectedBgColor			"LightBlue"				// selected text background
		...
		TextEntry.SelectedBgColor			"LightBlue"				// chat box text highlighted background
		
		Menu.TextColor               		"LightBlue"				// chat right click text
        Menu.BgColor               			"TransparentBlack"			// chat right click background fill
        Menu.ArmedTextColor           		"LightBlue"				// chat right click text on hover
